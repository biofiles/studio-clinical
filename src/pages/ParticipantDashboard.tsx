...
import { Calendar, FileText, Bell, Activity, Download, MessageCircle, User, Shield, Clock, CheckCircle } from "lucide-react";
...
const ParticipantDashboard = ({ onLogout }: ParticipantDashboardProps) => {
  ...
  return (
    <div className="min-h-screen bg-studio-bg">
            ...
            <div className="space-y-3">
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-medium text-yellow-800">Daily Symptom Diary - Due Today</span>
                </div>
                <p className="text-sm text-yellow-700 mb-3">Quick 5-minute survey about your daily symptoms</p>
                <Button size="sm" className="w-full sm:w-auto">Complete Now</Button>
              </div>
            </div>
          </TabsContent>
          ...
          <TabsContent value="profile" className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                View Profile & Participant Token
              </Button>
      ...
      {/* AI Chatbot Button - Mobile optimized */}
