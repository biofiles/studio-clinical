...
const translations = {
  english: {
    ...
    'user.invite.new': 'Invite New User',
    ...
    'user.resend.invitation': 'Resend Invitation',
    'user.all.studies': 'All Studies',
    'user.loading': 'Loading users...',
    'user.no.found': 'No users found',
    'user.invitation.sent': 'User invitation sent successfully',
    'user.activated': 'User activated successfully',
    'user.deactivated': 'User deactivated successfully',
    'user.full.name': 'Full Name',
    'user.email': 'Email',
    'user.send.invitation': 'Send Invitation',
    
    // Participant Creation
    'participant.create': 'Create Participant Account',
    'participant.subject.id': 'Subject ID',
    'participant.first.name': 'First Name',  
    'participant.last.name': 'Last Name',
    'participant.email.optional': 'Email (Optional)',
    'participant.email.placeholder': 'participant@example.com (leave blank to auto-generate)',
    'participant.date.birth': 'Date of Birth',
    'participant.gender': 'Gender',
    'participant.ethnicity': 'Ethnicity',
    'participant.ethnicity.hispanic': 'Hispanic or Latino',
    'participant.ethnicity.not.hispanic': 'Not Hispanic or Latino',
    'participant.ethnicity.unknown': 'Unknown',
    'participant.ethnicity.not.reported': 'Not Reported',
    'participant.create.account': 'Create Account',
    ...
    'participant.share.secure': '• Share these credentials securely with the participant',
    'participant.change.password': '• The participant should change their password on first login',
    'participant.token.privacy': '• The participant token is used for data privacy and compliance',
    
    // Activity Dashboard
    'activity.dashboard': 'User Activity Dashboard',
    'activity.total': 'Total Activities',
    'activity.today': 'Today',
    'activity.week': 'This Week',
    'activity.active.users': 'Active Users',
    'activity.search.placeholder': 'Search activities, users...',
    'activity.type': 'Activity Type',
    'activity.all.activities': 'All Activities',
    'activity.all.time': 'All Time',
    ...
    'activity.time': 'Time',
    'activity.unknown.user': 'Unknown User',
    ...
    'bulk.file.drag': 'Or drag and drop your CSV file here',
    'bulk.preview': 'Preview Import Data',
    ...
    'pls.signup': 'Study Summary',
    'pls.title': 'Study Summary Signup', 
    'pls.description': 'Receive a plain language summary of study results once data analysis is complete',
    'pls.success': 'Successfully signed up for study summary!',
    'pls.already.signed': 'Already signed up for study summary',
    'pls.manage.emails': 'Manage Email Addresses',
    'pls.email.confirmation.title': 'Study Summary',
    'pls.email.confirmation.description': 'Enter your email address to receive a plain language summary of study results once data analysis is complete.',
    'pls.email.address': 'Email Address',
    'pls.add.email.address': 'Add Email Address',
    'pls.registered.emails': 'Registered Email Addresses',
    ...
    'pls.email.already.registered': 'This email is already registered for study results.',
    'pls.email.invalid.format': 'Please enter a valid email address.',
    'pls.email.at.least.one': 'Please enter an email address.',
    'pls.confirm.signup': 'Sign Up',
  ...
  spanish: {
    ...
    'pls.signup': 'Resumen del Estudio',
    'pls.title': 'Inscripción para Resumen del Estudio',
    ...
    'pls.success': '¡Inscripción exitosa para resumen del estudio!',
    'pls.already.signed': 'Ya inscrito para resumen del estudio',
    'pls.manage.emails': 'Gestionar Direcciones de Email',
    'pls.email.confirmation.title': 'Resumen del Estudio',
    'pls.email.confirmation.description': 'Ingresa tu dirección de correo electrónico para recibir un resumen en lenguaje sencillo de los resultados del estudio una vez que se complete el análisis de los datos.',
    'pls.email.address': 'Dirección de Email',
    'pls.add.email.address': 'Agregar Dirección de Email',
    'pls.registered.emails': 'Direcciones de Email Registradas',
    ...
    'pls.email.already.registered': 'Este email ya está registrado para recibir los resultados del estudio.',
    'pls.email.invalid.format': 'Por favor ingresa una dirección de email válida.',
    'pls.email.at.least.one': 'Por favor ingresa una dirección de email.',
    'pls.confirm.signup': 'Inscribirse',
