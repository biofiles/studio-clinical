...
const translations = {
  english: {
    ...
    'documents.description': 'Manage and access study documents',
    'documents.upload.button': 'Upload Document',
    'documents.upload.title': 'Upload New Document',
    'documents.upload.description': 'Add a new document to the repository',
    'documents.file.select': 'Select File',
    'documents.name': 'Document Name',
    'documents.type': 'Document Type',
    'documents.type.protocol': 'Study Protocol',
    'documents.type.icf': 'Informed Consent Form',
    'documents.type.amendment': 'Protocol Amendment',
    'documents.type.safety': 'Safety Report',
    'documents.type.regulatory': 'Regulatory Document',
    'documents.type.other': 'Other',
    'documents.version': 'Version',
    'documents.upload.date': 'Upload Date',
    'documents.uploaded.by': 'Uploaded By',
    ...
    'documents.upload.error': 'Error uploading document',
    'documents.no.documents': 'No documents found',
    'documents.search.placeholder': 'Search documents...',
    'documents.filter.all': 'All Types',
    
    // Document Names
    'documents.name.study.protocol': 'Study Protocol',
    'documents.name.icf': 'Informed Consent Form',
    'documents.name.safety.monitoring': 'Safety Monitoring Plan',
    'documents.name.cv.endpoint.charter': 'Cardiovascular Endpoint Adjudication Charter',
    'documents.name.protocol.amendment.ecg': 'Protocol Amendment 1 - ECG Monitoring',
    'documents.name.diabetes.guidelines': 'Diabetes Management Guidelines',
    'documents.name.hba1c.manual': 'HbA1c Laboratory Manual',
    'documents.name.tumor.assessment': 'Tumor Assessment Guidelines',
    'documents.name.biomarker.protocol': 'Biomarker Analysis Protocol',
    'documents.name.pediatric.safety': 'Pediatric Safety Guidelines',
    'documents.name.growth.assessment': 'Growth Assessment Manual',
    ...
    'activity.site.visit.blood.draw': 'Site Visit - Blood Draw',
    'activity.follow.up.call': 'Follow-up Call',
    'activity.safety.assessment': 'Safety Assessment',
    'activity.site.visit': 'Site Visit',
    'activity.weekly.survey.due': 'Weekly Survey Due',
    ...
    'settings.display.dark.mode': 'Dark Mode',
    'settings.display.dark.mode.description': 'Toggle between light and dark theme',
    'settings.display.font.size': 'Font Size',
    'settings.display.font.size.description': 'Adjust the application font size',
    'settings.display.font.size.small': 'Small',
    'settings.display.font.size.medium': 'Medium', 
    'settings.display.font.size.large': 'Large',
    'settings.connection.settings': 'Connection Settings',
    'settings.connection.offline.mode': 'WiFi Only Mode',
    'settings.connection.offline.mode.description': 'Data will transmit when connected to a WiFi network',
  ...
  spanish: {
    ...
    // Document Repository
    'documents.title': 'Repositorio de Documentos',
    'documents.description': 'Gestionar y acceder a documentos del estudio',
    'documents.upload.button': 'Subir Documento',
    'documents.upload.title': 'Subir Nuevo Documento',
    'documents.upload.description': 'Agregar un nuevo documento al repositorio',
    'documents.file.select': 'Seleccionar Archivo',
    'documents.name': 'Nombre del Documento',
    'documents.type': 'Tipo de Documento',
    'documents.type.protocol': 'Protocolo del Estudio',
    'documents.type.icf': 'Formulario de Consentimiento Informado',
    'documents.type.amendment': 'Enmienda del Protocolo',
    'documents.type.safety': 'Informe de Seguridad',
    'documents.type.regulatory': 'Documento Regulatorio',
    'documents.type.other': 'Otro',
    'documents.version': 'Versión',
    'documents.upload.date': 'Fecha de Subida',
    'documents.uploaded.by': 'Subido Por',
    'documents.file.size': 'Tamaño del Archivo',
    'documents.actions': 'Acciones',
    'documents.download': 'Descargar',
    'documents.view': 'Ver',
    'documents.delete': 'Eliminar',
    'documents.upload.success': 'Documento subido exitosamente',
    'documents.upload.error': 'Error al subir documento',
    'documents.no.documents': 'No se encontraron documentos',
    'documents.search.placeholder': 'Buscar documentos...',
    'documents.filter.all': 'Todos los Tipos',
    
    // Document Names
    'documents.name.study.protocol': 'Protocolo del Estudio',
    'documents.name.icf': 'Formulario de Consentimiento Informado',
    'documents.name.safety.monitoring': 'Plan de Monitoreo de Seguridad',
    'documents.name.cv.endpoint.charter': 'Carta de Adjudicación de Endpoints Cardiovasculares',
    'documents.name.protocol.amendment.ecg': 'Enmienda del Protocolo 1 - Monitoreo ECG',
    'documents.name.diabetes.guidelines': 'Guías de Manejo de Diabetes',
    'documents.name.hba1c.manual': 'Manual de Laboratorio HbA1c',
    'documents.name.tumor.assessment': 'Guías de Evaluación de Tumores',
    'documents.name.biomarker.protocol': 'Protocolo de Análisis de Biomarcadores',
    'documents.name.pediatric.safety': 'Guías de Seguridad Pediátrica',
    'documents.name.growth.assessment': 'Manual de Evaluación del Crecimiento',
    ...
    'activity.site.visit.blood.draw': 'Visita al Sitio - Extracción de Sangre',
    'activity.follow.up.call': 'Llamada de Seguimiento',
    'activity.safety.assessment': 'Evaluación de Seguridad',
    'activity.site.visit': 'Visita al Sitio',
    'activity.weekly.survey.due': 'Cuestionario Semanal Pendiente',
    ...
    'settings.display.preferences': 'Preferencias de Visualización',
    'settings.display.dark.mode': 'Modo Oscuro',
    'settings.display.dark.mode.description': 'Alternar entre tema claro y oscuro',
    'settings.display.font.size': 'Tamaño de Fuente',
    'settings.display.font.size.description': 'Ajustar el tamaño de fuente de la aplicación',
    'settings.display.font.size.small': 'Pequeño',
    'settings.display.font.size.medium': 'Mediano',
    'settings.display.font.size.large': 'Grande',
    'settings.connection.settings': 'Configuración de Conexión',
    'settings.connection.offline.mode': 'Solo WiFi',
    'settings.connection.offline.mode.description': 'Los datos se transmitirán cuando se conecte a una red WiFi',
    'settings.tutorial.section': 'Tutorial',
