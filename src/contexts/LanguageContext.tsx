...
const translations = {
  english: {
    ...
    'pls.email.note': 'These emails will only be used to send you the study results summary.',
    ...
    'pls.email.at.least.one': 'Please add at least one email address.',
  ...
  spanish: {
    ...
    'pls.email.confirmation.description': 'Confirma las direcciones de correo electrónico donde te gustaría recibir el resumen en lenguaje sencillo de los resultados del estudio una vez que se complete el análisis de los datos.',
    ...
    'pls.email.note': 'Estos emails solo se usarán para enviarte el resumen de los resultados del estudio.',
    ...
    'pls.email.at.least.one': 'Por favor agrega al menos una dirección de email.',
